...
numberConst = 5; 
Неможливо змінити значення змінної, оголошеної через const,
оскільки воно задається один раз і залишається незмінним, тому при зміні значення виникає помилка.*/
